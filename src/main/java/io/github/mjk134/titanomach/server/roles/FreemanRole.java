...
public class FreemanRole extends Role {
    public FreemanRole() {
        ...
        addPlayerTask(new TaskInfo(TaskType.COLLECTION, "minecraft:oak_log", 3*64, 700));               // mid
        ...
        addPlayerTask(new TaskInfo(TaskType.ADVANCEMENT, "minecraft:story/enchant_item", 1, 300));        // easy
        addPlayerTask(new TaskInfo(TaskType.ADVANCEMENT, "minecraft:story/mine_diamond", 1, 300));
        addPlayerTask(new TaskInfo(TaskType.COLLECTION, "minecraft:pumpkin", 32, 500));                 // mid
        ...
        addPlayerTask(new TaskInfo(TaskType.COLLECTION, "minecraft:leather", 64, 700));                 // from cows
        addPlayerTask(new TaskInfo(TaskType.SLAYER, "minecraft:witch", 3, 700));                        // rare mob

        addGlobalTask(new GlobalCollectionTask("freeman-global-1", 4*64, 1000, "minecraft:coal"));     // mining
        addGlobalTask(new GlobalSlayerTask("freeman-global-2", 50, 800, "minecraft:drowned"));         // combat
        addGlobalTask(new GlobalCollectionTask("freeman-global-3", 3*64, 700, "minecraft:wheat"));  // farming
    }
